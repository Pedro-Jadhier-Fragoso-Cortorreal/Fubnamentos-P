#include <stdio.h>
/* ventas descendentes
el programa, al recibir como datos tres valores que representan las ventas de los vendedores de una teinda de discos, escribe las ventas en orden descendente
