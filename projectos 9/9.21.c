#include <stdio.h>
/* Examen de admision
El programa al recibiri como dato un archivo de acceso directo que contiene informacion sobre alumnos que presentaron el examen de admision a una universidad, genera informacion importante para el departamento de control escolar */
...
void main(void)
{
    ...
    ap = fopen("alu1.dat", "r");
    /* Observa que los archivos car1.dat car2.dat car3.dat car4.dat y car5.dat se abren en la modalidad para eascribir y leer */
...
/* Esta funcion obtiene el promedio del examen de admision */
{
    ...
    /* wSTA FUNCION GENERA UN ARCHIVO DE LOS ALUMNOS ADMITIDOS EN CADA UNA DE LAS CARRERAS DE LA UNIVERSIDAD */
    {
        alumno alu;
        rewind(ap);
        fread(&alu, sizeof(alumno), 1, ap);
