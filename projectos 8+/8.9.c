...
/* Bienes raices.
El programa maneja informacion sobre las propiedades que tiene una empresa de bienes raices de la ciudad de Lima, Peru, tanto para vena como para renta. */
...
typedef struct /* Declaracion de la estructura ubicacion. */
{
 ...
 typedef struct  /* Declaracion de la estructura Ubicacion */
 {
     ...
     Ubicacion ubi;     /* Observa que este de campo es de tipo estructura ubicacion. */
...
/* Esta funcion se utiliza para generar un listado de las propiedades disponibles para venta en a zona de miraflores, cuyo valor oscila entre 450,000 y 650,000 soles. */
{
    int I;
