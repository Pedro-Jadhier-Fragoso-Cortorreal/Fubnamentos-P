...
/* Estructuras 1.
El programa muestra la manera en que se declara una estructura, asi como la forma que se tiene acceso a los campos de las variables de tipo estructura ranto para asignacion de valores como para lecetura y escritura. */

struct alumno     /* delcaracion de la estructura. */

{
    int matricula
    char nombre[20];
    carrera [20];
    float promedio;                    /* campos de estructura. */
    char direccion[20];
...
void main(void)
{
    ...
    /* Los compos de a2 reciben valores por medio de una lectura. */
    ...
    /*Observa itra forma de escribir los campos de la variable de tipo estructura a3. */
