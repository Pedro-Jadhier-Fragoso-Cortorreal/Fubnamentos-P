...
void main(void)
{
    ...
    /* Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumno reciben valores, ingresamos los valores de los campos de tres formas diferentes. los campos a1 reciben valores directamente, los campos de a2 se leen en el programa principal, y los campos de a3 reciben valores a traves de una funcion. */
    printf("Alumno 2\n");
    ...
    /* Obseva que en la variable a2 de tipo estructura alumno el segundo campo de la union recibe un valor. */
...
/* escribe el contenido del campo (hGIMENEZ@HOTMIL.COM). */
