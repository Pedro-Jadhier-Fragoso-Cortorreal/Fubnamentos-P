...
void main(void)
{
    ...
    while (TAM > 50| | TAM < 1); /* Se verifica que el tamaño del arregla sea correcto. */
...
/* La funcion F2 obtiene las matriculas de los alumnos cuya calificacion en la tercera materia es mayir a 9. */
{
    int I;
    printf("\nAlumnos con calificacion en la tercera materia > 9");
    for (I=0; I<T; I++)
        if (A[I].cal[2] > 9)
        printf("nMatricula del alumno: %d", A[I].matricula);
